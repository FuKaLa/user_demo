...
//            System.out.println("加密后文字:" + encryptBASE64(encodedData));
            String a = "vxsn34t+k4gLm0CcXasEk4oZwVw9RwI90vaicLEhUxELVtktFRfMva5zCBJrXHU+YQqU6gXGyy3V" +
                    "Nl+Q8lMTEp0BNFLgOsQBVlxWX9zT5tH2jq5Jf4nFew8M0I+sOdWFwMMZGLdq30WrWnFt3nmUJKGw" +
                    "mvSHBmCncaxLHaCKTck=";
            byte[] decodedData = decryptByPrivateKey(decryptBASE64(a), "MIICeAIBADANBgkqhkiG9w0BAQEFAASCAmIwggJeAgEAAoGBAN3bOpeM8JTYVO6GZhb6mf0d9Ef1" +
                    "v/XC2dMbyZxpHwAtWB0RC7mdZ5A3ZxRGiqcrLl89ZAsiMz9rirVWEejjGjU0JVy05gqOehHyEVqX" +
                    "WZyW3K7QxDEjS4gZLVi40ETA0Xlp+qCllNdhzMPTmr6EwOj+ZO2zp5r0QjqsM3xjMWwPAgMBAAEC");
            String target = new String(decodedData);
            System.out.println("解密后文字: " + target);

//            System.err.println("私钥加密——公钥解密");
//            String source1 = "这是一行测试RSA数字签名的无意义文字";
//            System.out.println("原文字：" + source1);
//            byte[] data1 = source1.getBytes();
//            byte[] encodedData1 = encryptByPrivateKey(data1, privateKey);
//            System.out.println("加密后：" + new String(encodedData1));
//            byte[] decodedData1 = decryptByPublicKey(encodedData1, publicKey);
//            String target1 = new String(decodedData1);
//            System.out.println("解密后: " + target1);
